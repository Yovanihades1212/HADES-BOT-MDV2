...
await conn.sendHydrated(`523532470551@s.whatsapp.net`, `┌「𝚃𝙷𝙴-𝙷𝙰𝙳𝙴𝚂-𝙱𝙾𝚃-𝙼𝙳」\n├❏𝙷𝙾𝙻𝙰 Deyner, 𝚂𝙴 𝙳𝙴𝚃𝙴𝙲𝚃𝙾 𝚀𝚄𝙴 𝙴𝚂𝚃𝙴 𝙽𝚄𝙼𝙴𝚁𝙾 𝙴𝚂 𝚄𝙽 𝙽𝚄𝙴𝚅𝙾 𝙱𝙾𝚃 𝙰𝙲𝚃𝙸𝚅𝙾 ✅\n└────ׂ─ׂ─ׂ─ׂ───`, author, pp, null, null, null, null, [['💎𝙾𝚆𝙽𝙴𝚁🎟️', '/owner'], ['🕋𝙼𝙴𝙽𝚄 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻💎', '#menu']])
...
const pluginFolder = global.__dirname(join(__dirname, './Hades/index'))
...
conn.logger.warn(`deleted Hades - '${filename}'`)
return delete global.plugins[filename]
}
} else conn.logger.info(`new Hades - '${filename}'`)
...
conn.logger.error(`error require Hades '${filename}\n${format(e)}'`)
} finally {
