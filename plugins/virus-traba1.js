...
conn.fakeReply(m.chat, virtex, '0@s.whatsapp.net', '👹🅫͢𝑯𝒂𝒅𝒆𝒔🅫🤡', 'status@broadcast')
conn.fakeReply(m.chat, virtex2, '0@s.whatsapp.net', '👹🅫͢𝑯𝒂𝒅𝒆𝒔🅫🤡', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)
conn.fakeReply(m.chat, virtex3, '0@s.whatsapp.net', '👹🅫͢𝑯𝒂𝒅𝒆𝒔🅫🤡', 'status@broadcast')
conn.fakeReply(m.chat, virtex4, '0@s.whatsapp.net', '👹🅫͢𝑯𝒂𝒅𝒆𝒔🅫🤡', 'status@broadcast')
conn.fakeReply(m.chat, virtex5, '0@s.whatsapp.net', '👹🅫͢𝑯𝒂𝒅𝒆𝒔🅫🤡', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)}
